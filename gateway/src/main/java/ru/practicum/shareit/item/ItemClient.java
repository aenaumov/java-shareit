...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> addItem(ItemDtoCreate itemDto, Long userId) {
        return post("", userId, itemDto);
    }

    public ResponseEntity<Object> updateItem(ItemDtoCreate itemDto, Long itemId, Long userId) {
        return patch("/" + itemId, userId, itemDto);
    }

    public ResponseEntity<Object> getOneItem(Long itemId, Long userId) {
